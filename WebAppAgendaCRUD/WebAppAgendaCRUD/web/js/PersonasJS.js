...
$(function () {
    ...
    $(".pag").click(function(){
        clearActives();
        consultarPersonas($(this).val());
        $(this).addClass("active");
    });
    
    $("#btBuscar").click(function(){
        buscarPersonas($("#name").val());
    });
...
$(document).ready(function () {
    consultarPersonas(1); //Para ver la rimera pagina solamente al iniciar
});
...
function consultarPersonas(pag) {
...
function dibujarTabla(dataJson,pag) {
...
function eliminarPersona(idPersona) {
    bootbox.confirm({
        message: "Seguro que desea eliminar a la persona seleccionada? Recuerde que al realizar esta acción no podrá recuperarla",
        buttons: {
            confirm: {
                label: 'Confirmar',
...
function buscarPersonas(name){
    mostrarModal("myModal", "Espere por favor..", "Estamos buscando a " + name);
    $.ajax({
        url: 'PersonasServlet',
        data: {
